...
class Player(db.Model):
    ...
    world = db.relationship('World', back_populates='players')
    ...
    def update_status(self, changes):
        try:
            valid_attributes = ['strength', 'dexterity', 'intelligence', 'agility', 'luck', 'hp', 'sanity']
            for key, value in changes.items():
                if key in valid_attributes and hasattr(self.status, key):
